...
#===============================================================
# Taking the output files from GLM16 and GLM17 and combining them with ABI, ENI, and MRMS
# into one dataset in the netCDF format. Includes the 103 W line for East/West data, and filtering for over CONUS.
# May be updated in the future to include additional fitlers as needed.
# An extension of GLM-postprocess-merger-v3.py (now with the MRMS T-10 minute data included
#
...
def get_combo_meta_data():
    ...
    mrms_meta_dict = {
        ...
        'MergedReflectivityQCComposite_max_pre10': ['1','max in MRMS comp refl within 20 km 10 minutes before the GLM first flash', ('number_of_flashes',),'float',False],
        'MergedReflectivityQCComposite_95_pre10': ['1','95th percentile in MRMS comp refl within 20 km 10 minutes before the GLM first flash',('number_of_flashes',),'float',False],
        'Reflectivity_-10C_max_pre10': ['1','max in MRMS -10C refl within 20 km 10 minutes before the GLM first flash', ('number_of_flashes',),'float',False],
        'Reflectivity_-10C_95_pre10': ['1','95th percentile in MRMS -10C refl within 20 km 10 minutes before the GLM first flash', ('number_of_flashes',),'float',False],
        'ReflectivityAtLowestAltitude_max_pre10': ['1','max in MRMS RALA within 20 km 10 minutes before the GLM first flash', ('number_of_flashes',),'float',False],
        'ReflectivityAtLowestAltitude_95_pre10': ['1','95th percentile in MRMS RALA within 20 km 10 minutes before the GLM first flash', ('number_of_flashes',),'float',False],
    }
...
mrms16_loc = '/localdata/first-flash/data/MRMS-processed-GLM16-v2/MRMS-compiled-GLM16-v2.csv'
mrms17_loc = '/localdata/first-flash/data/MRMS-processed-GLM17-v2/MRMS-compiled-GLM17-v2.csv'
